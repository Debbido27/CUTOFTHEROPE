...
import java.io.Serializable;  // ← LÍNEA 1: IMPORT
import java.time.LocalDate;

public class PartidaHistorial implements Serializable {  // ← LÍNEA 2: IMPLEMENTS
    ...
    // Constructor para SesionJuego (sin fallos)
