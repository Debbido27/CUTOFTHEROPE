        ...
        @Override public void dispose() { escenario.dispose(); piel.dispose(); logoTexture.dispose(); bgTexture.dispose(); btnTexture.dispose(); btnOverTexture.dispose(); batch.dispose(); }
        }
